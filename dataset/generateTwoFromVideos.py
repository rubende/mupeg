...
if __name__ == "__main__":
    ...
    if inputtype == 'video':
        MuPeGGenerator.generate_two_subjects_from_videos(datasetdir, siltdir, idsdir, outputdir, videotypes_background,
                                                         videotypes_foreground, height, width, framerate)
    else:
        MuPeGGenerator.generate_two_subjects_from_images(datasetdir, siltdir, idsdir, outputdir, videotypes_background,
                                                         videotypes_foreground, height, width, framerate)
