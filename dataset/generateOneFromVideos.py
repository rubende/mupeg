...
import numpy as np
import importlib
MuPeGGenerator = importlib.import_module('cnngait_tf.mupeg.dataset.MuPeG')
...
if __name__ == "__main__":
    ...
    if inputtype == 'video':
        MuPeGGenerator.generate_one_subject_from_videos(datasetdir, siltdir, idsdir, outputdir, background, videotypes, height, width, framerate)
    else:
        MuPeGGenerator.generate_one_subject_from_images(datasetdir, siltdir, idsdir, outputdir, background, videotypes, height, width, framerate)
