...
class MuPeGGeenerator:

    def generate_one_subject_from_images(self, datasetdir, siltdir, idsdir, outputdir, background, videotypes, height,
                                         width, framerate):
    ...
    def generate_two_subjects_from_images(self, datasetdir, siltdir, idsdir, outputdir, videotypes_background,
    ...
    def generate_one_subject_from_videos(self, datasetdir, siltdir, idsdir, outputdir, background, videotypes, height,
                                         width, framerate):
    ...
    def generate_two_subjects_from_videos(self, datasetdir, siltdir, idsdir, outputdir, videotypes_background,
                                        videotypes_foreground, height, width, framerate):
